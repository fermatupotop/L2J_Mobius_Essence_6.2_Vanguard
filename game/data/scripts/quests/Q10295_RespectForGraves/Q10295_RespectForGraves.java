...
public class Q10295_RespectForGraves extends Quest
{
	...
	// Reward
	private static final ItemHolder RC_STONE = new ItemHolder(93080, 1);
	private static final ItemHolder SAYHA_GUST = new ItemHolder(91776, 15);
	// Misc
	...
	public Set<NpcLogListHolder> getNpcLogList(Player player)
	{
		...
		if ((qs != null) && qs.isCond(1))
		{
			...
			holder.add(new NpcLogListHolder(NpcStringId.LEVEL_52_ACCOMPLISHED, player.getLevel() > 52 ? 1 : 0));
			return holder;
		}
