...
public class GameAssistant extends AbstractNpcAI
{
	...
	private static final int EX_SEALS_OF_GIRAN = 3247848;
	private static final int EX_LA_VIE_EN_ROSE = 3247841;
	private static final int Ex_GOLDEN_WHEEL = 3247847;
	private static final int Ex_GOLDEN_TICKET = 3247849;
	...
	private static final int EX_PRIME_SHOP = 3700000;
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "Ex_SealsOfGiran":
			{
				MultisellData.getInstance().separateAndSend(EX_SEALS_OF_GIRAN, player, null, false);
				break;
			}
			...
			case "Ex_GoldenWheelShop":
			{
				MultisellData.getInstance().separateAndSend(Ex_GOLDEN_WHEEL, player, null, false);
				break;
			}
			case "Ex_GoldenWheelShopTicket":
			{
				MultisellData.getInstance().separateAndSend(Ex_GOLDEN_TICKET, player, null, false);
				break;
			}
			case "Ex_HeavyAGrade":
			{
			...
			case "Ex_PrimeShop":
			{
				MultisellData.getInstance().separateAndSend(EX_PRIME_SHOP, player, null, false);
				break;
			}
