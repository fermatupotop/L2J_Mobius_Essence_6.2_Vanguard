...
public class Atingo extends AbstractNpcAI
{
	...
	private static final Location[] SPAWNS =
	{
		...
		new Location(-96094, 107013, -3736, 16115), // Orc Barracks
		new Location(-92924, 106480, -3444, 16115), // Orc Barracks
		new Location(96547, 110310, -3734, 37355), // Dragon Valley's
		new Location(84628, 118831, -3042, 37355), // Dragon Valley's
	};
	// Misc
