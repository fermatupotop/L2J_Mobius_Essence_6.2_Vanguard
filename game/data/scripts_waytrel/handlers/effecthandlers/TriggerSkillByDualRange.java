...
public class TriggerSkillByDualRange extends AbstractEffect
{
	...
	{
		if ((effected == null) || !effector.isPlayer() || effected.isInsidePeaceZone(effector))
		{
			return;
		}
		...
		if (queuedSkill != null)
		{
			ThreadPool.schedule(() -> effector.getActingPlayer().setQueuedSkill(queuedSkill.getSkill(), queuedSkill.getItem(), queuedSkill.isCtrlPressed(), queuedSkill.isShiftPressed()), 10);
		}
