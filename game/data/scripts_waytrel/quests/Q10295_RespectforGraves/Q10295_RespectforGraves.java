...
public class Q10295_RespectforGraves extends Quest
{
	...
	public Q10295_RespectforGraves()
	{
		...
		addStartNpc(ORVEN);
		addTalkId(ORVEN);
		addKillId(TAIK_ORC_WATCHMAN, GRAVE_GUARD, TAIK_ORC_SUPPLY_OFFICER, TAIRIM, TORTURED_UNDEAD, SPITEFUL_GHOST_OF_RUINS, SOLDIER_OF_GRIEF, CRUEL_PUNISHER, ROVING_SOUL, SOUL_OF_RUNIS, GRAVE_WARDEN);
		addCondMinLevel(MIN_LEVEL, "no_lvl.html");
		// addCondMaxLevel(MAX_LEVEL, "no_lvl.html");
		setQuestNameNpcStringId(NpcStringId.LV_44_50_RESPECT_FOR_GRAVES);
	}
	...
	public Set<NpcLogListHolder> getNpcLogList(Player player)
	{
		...
		if ((qs != null) && qs.isCond(1))
		{
			...
			holder.add(new NpcLogListHolder(NpcStringId.LEVEL_50_ACCOMPLISHED, player.getLevel() > 49 ? 1 : 0));
			return holder;
		}
	...
	{
		return (qs != null) && qs.isCond(1) && (player.getLevel() > 49) && (qs.getInt(KILL_COUNT_VAR) >= 500);
	}
