...
public class Q10298_TracesOfBattle extends Quest
{
	...
	// Misc
	private static final int MIN_LEVEL = 61; // 64 defoult
	private static final int MAX_LEVEL = 85; // 64 defoult
	...
	public Q10298_TracesOfBattle()
	{
		...
		// addCondCompletedQuest(Q10297_MemoryOfTheGloriousPast.class.getSimpleName(), "no_lvl.html");
		setQuestNameNpcStringId(NpcStringId.LV_61_TRACES_OF_BATTLE);
	}
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		else if (qs.isStarted())
		{
			if (qs.isCond(1))
			{
				...
				if ((killCount < 1200) && (player.getLevel() < 69))
				{
	...
	{
		return (qs != null) && qs.isCond(1) && (player.getLevel() > 69) && (qs.getInt(KILL_COUNT_VAR) >= 1200);
	}
