...
public class Q10297_MemoryOfTheGloriousPast extends Quest
{
	...
	// Misc
	private static final int MIN_LEVEL = 56; // 58 defoult
	private static final int MAX_LEVEL = 85; // 58 defoult
	...
	public Q10297_MemoryOfTheGloriousPast()
	{
		...
		// addCondCompletedQuest(Q10296_LetsPayRespectsToOurFallenBrethren.class.getSimpleName(), "no_lvl.html");
		setQuestNameNpcStringId(NpcStringId.LV_56_MEMORY_OF_THE_GLORIOUS_PAST_IN_PROGRESS);
	}
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		else if (qs.isStarted())
		{
			if (qs.isCond(1))
			{
				...
				if ((killCount < 1000) && (player.getLevel() < 60))
				{
	...
	public Set<NpcLogListHolder> getNpcLogList(Player player)
	{
		...
		if ((qs != null) && qs.isCond(1))
		{
			...
			holder.add(new NpcLogListHolder(NpcStringId.REACH_LV_61, player.getLevel() > 60 ? 1 : 0));
			return holder;
		}
	...
	{
		return (qs != null) && qs.isCond(1) && (player.getLevel() > 60) && (qs.getInt(KILL_COUNT_VAR) >= 1000);
	}
