...
public class Q10290_ATripBegins extends Quest
{
	...
	private static final Location TELEPORT_TO_RUIN = new Location(-45988, 116466, -3561);
	// Misc
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			case "30256-03.html":
			{
				...
				player.teleToLocation(TELEPORT_TO_RUIN);
				// htmltext = event;
				break;
			}
			case "30332-02.html":
			{
				if (qs.isCond(3))
				{
					...
					// addExpAndSp(player, 800000, 42000);
    ...
    public void actionForEachPlayer(Player player, Npc npc, boolean isSummon)
    {
		...
		if ((qs != null) && qs.isCond(2) && player.isInsideRadius3D(npc, Config.ALT_PARTY_RANGE))
        {
            ...
            { 
                ...
                showOnScreenMsg(player, NpcStringId.YOU_VE_KILLED_ALL_THE_MONSTERS_USE_THE_SCROLL_OF_ESCAPE_IN_YOUR_INVENTORY_TO_RETURN_TO_CAPTAIN_BATHIS_IN_GLUDIO, ExShowScreenMessage.TOP_CENTER, 10000, player.getName());
