...
public class Q10296_LetsPayRespectsToOurFallenBrethren extends Quest
{
	...
	// Misc
	private static final int MIN_LEVEL = 50; // 52 defoult
	private static final int MAX_LEVEL = 85; // 52 defoult
	...
	public Q10296_LetsPayRespectsToOurFallenBrethren()
	{
		...
		setQuestNameNpcStringId(NpcStringId.LV_50_PAY_RESPECTS_TO_FALLEN_BRETHREN);
	}
	...
	public String onTalk(Npc npc, Player player)
	{
		...
		else if (qs.isStarted())
		{
			if (qs.isCond(1))
			{
				...
				if ((killCount < 800) && (player.getLevel() < 55))
				{
	...
	public Set<NpcLogListHolder> getNpcLogList(Player player)
	{
		...
		if ((qs != null) && qs.isCond(1))
		{
			...
			holder.add(new NpcLogListHolder(NpcStringId.LEVEL_52_ACCOMPLISHED, player.getLevel() > 55 ? 1 : 0));
			return holder;
		}
	...
	{
		return (qs != null) && qs.isCond(1) && (player.getLevel() > 55) && (qs.getInt(KILL_COUNT_VAR) >= 800);
	}
