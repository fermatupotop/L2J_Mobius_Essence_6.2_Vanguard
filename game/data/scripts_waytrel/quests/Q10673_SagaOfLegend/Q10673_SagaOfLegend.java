...
public class Q10673_SagaOfLegend extends Quest
{
	...
	private static final int SPELLBOOK_HUMAN = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_ELF = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_DELF = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_ORC = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_DWARF = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_KAMAEL = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_DEATH_KNIGHT = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_SYLPH = 93974; // Pattern Slot Expansion Ticket
	private static final int SPELLBOOK_VANGUARD = 93974; // Pattern Slot Expansion Ticket
	// Misc
	...
	{
		final QuestState qs = getQuestState(player, false);
		if ((qs != null) && ((qs.getCond() > 1) && (qs.getCond() < 5) && player.isInsideRadius3D(npc, Config.ALT_PARTY_RANGE)))
		{
	...
	public void onProfessionChange(OnPlayerProfessionChange event)
	{
		...
		{
			player.getVariables().set("3rdClassMountRewarded", true);
			giveItems(player, SPELLBOOK_VANGUARD, 1);
			return;
		}
