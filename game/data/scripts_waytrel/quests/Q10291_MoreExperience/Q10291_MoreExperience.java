...
public class Q10291_MoreExperience extends Quest
{
	...
	// Location
	private static final Location TELEPORT_ABANDNED_CAMP = new Location(-47436, 148744, -3015);
	// Items
	...
	private static final int MIN_LEVEL = 25; // 25 defoult
	private static final int MAX_LEVEL = 30; // 30 defoult
	...
	public String onAdvEvent(String event, Npc npc, Player player)
	{
		...
		switch (event)
		{
			...
			{
				qs.startQuest();
				player.teleToLocation(TELEPORT_ABANDNED_CAMP);
			...
			case "30332-06.html":
			{
				...
				// addExpAndSp(player, 1500000, 117500);
    ...
    public void actionForEachPlayer(Player player, Npc npc, boolean isSummon)
	{
		...
		if ((qs != null) && qs.isCond(1) && player.isInsideRadius3D(npc, Config.ALT_PARTY_RANGE))
		{
			...
			else
			{
				...
				player.sendPacket(new ExShowScreenMessage(NpcStringId.MONSTERS_OF_THE_ABANDONED_CAMP_ARE_KILLED_USE_THE_TELEPORT_TO_GET_TO_BATHIS_IN_GLUDIO, 2, 5000));
